        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Link 
                to="/add-pet" 
                className="inline-flex items-center justify-center bg-white/80 text-text-dark border-2 border-light-accent px-8 py-4 rounded-full font-semibold text-lg hover:border-primary-orange hover:text-primary-orange hover:bg-white transition-all duration-300 shadow-soft"
              >
                Report Lost Pet
              </Link>
            </div>
            ...
            {/* Stats */}
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 mt-12 pt-8 border-t border-primary-orange/20">
              <div>
                <div className="text-3xl md:text-4xl font-bold text-primary-orange">2,500+</div>
                <div className="text-sm md:text-base text-text-dark/60">Pets Reunited</div>
              </div>
              <div>
                <div className="text-3xl md:text-4xl font-bold text-primary-orange">1,200+</div>
                <div className="text-sm md:text-base text-text-dark/60">Successful Adoptions</div>
              </div>
              <div>
                <div className="text-3xl md:text-4xl font-bold text-primary-orange">500+</div>
                <div className="text-sm md:text-base text-text-dark/60">Active Volunteers</div>
              </div>
              <div>
                <div className="text-3xl md:text-4xl font-bold text-primary-orange">10K+</div>
                <div className="text-sm md:text-base text-text-dark/60">Registered Users</div>
              </div>
            </div>
          </div>
      ...
      <section className="bg-white/50 py-20">
        <div className="max-w-[96rem] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="bg-white rounded-3xl p-8 md:p-10 shadow-soft hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
              <div className="w-20 h-20 bg-primary-orange/10 rounded-2xl flex items-center justify-center mb-8 mx-auto">
                <span className="text-3xl md:text-4xl">🤖</span>
              </div>
              <h3 className="text-2xl font-bold text-text-dark mb-4 text-center">AI Image Matching</h3>
              <p className="text-text-dark/70 text-center leading-relaxed">
            ...
            <div className="bg-white rounded-3xl p-8 md:p-10 shadow-soft hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
              ...
              <h3 className="text-2xl font-bold text-text-dark mb-4 text-center">Location-based Alerts</h3>
              <p className="text-text-dark/70 text-center leading-relaxed">
            ...
            <div className="bg-white rounded-3xl p-8 md:p-10 shadow-soft hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
              ...
              <h3 className="text-2xl font-bold text-text-dark mb-4 text-center">Secure Adoption</h3>
              <p className="text-text-dark/70 text-center leading-relaxed">
