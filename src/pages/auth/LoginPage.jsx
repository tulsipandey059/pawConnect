      ...
      <div className="max-w-md w-full bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl p-6 md:p-8 border border-white/50 max-h-screen overflow-hidden">
        ...
        <div className="space-y-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-primary-orange to-orange-500 text-white py-4 rounded-xl font-bold shadow-xl hover:shadow-2xl hover:scale-[1.02] transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-orange-500/50"
            >
              Sign In
            </button>
          </form>
          ...
          <div className="space-y-3 pb-4">
            <button className="flex items-center justify-center py-3 px-4 border border-gray-200 rounded-xl hover:bg-gray-50 transition-all duration-300 w-full hover:shadow-md hover:border-gray-300">
